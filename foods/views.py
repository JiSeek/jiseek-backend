...
def food_search(request):
    ...
    total_essential_fatty_acids = request.GET.get("total_essential_fatty_acids", None)
    total_saturated_fatty_acids = request.GET.get("total_saturated_fatty_acids", None)
