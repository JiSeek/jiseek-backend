...
def load_network(config_file, data_file, weights, batch_size=1):
    ...
    # class_names = [metadata.names[i].decode("ascii") for i in range(metadata.classes)] # customed
...
def draw_boxes(detections, image, colors):
    ...
    for label, confidence, bbox in detections:
        ...
        print("left:", left, "right:", right, "top:", top, "bottom:", bottom, "label:", label, "confidence:", confidence)
